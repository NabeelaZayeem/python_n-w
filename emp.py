...
class Employee:
    def __init__(self,name,sap,address,contact):
        self.name=name
        self.sap=sap
...
Employee("Nabeela", "52138710", "hcl pune", "12345678"),
...
class Project:
    def __init__(self,Project_ID,sap,Project_Name):
...
#Workbook.close()C:\Users\user794\Documents